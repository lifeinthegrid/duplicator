...
class DUPX_ServerConfig
{
	...
	public static function reset($path)
	{
		...
		if (self::runReset($path, '.htaccess')) {
			file_put_contents("{$path}/.htaccess", '# This file has been reset by ' . $GLOBALS['DUPX_AC']->plugin_name .". See .htaccess-{$time}.orig for the original file");
	...
	public static function setup($mu_mode, $mu_generation, $dbh, $path)
	{
		...
		$update_msg  = '# This file was updated by ' . $GLOBALS['DUPX_AC']->plugin_name . " on {$timestamp}.\n";
